...
public class PlacementManager : MonoBehaviour
{
    ...
    public void DestroyItem(Vector3Int position)
    {
        if (gameObject.name == "StructureManager" || gameObject.name == "StructureModel")
        {
            Debug.Log("Can't destroy structure manager");
        }
        else
        {
            //placementGrid[position.x, position.y] = CellType.Empty;
            //StructureModel replace = CreateANewStructureModel()
            ////print(placementGrid[0,1]);
